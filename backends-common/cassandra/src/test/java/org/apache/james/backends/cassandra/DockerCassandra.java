...
public class DockerCassandra {
    ...
    public static class CassandraResourcesInitializer {
        ...
        private CassandraResourcesInitializer(DockerCassandra cassandra) {
            this.cassandra = cassandra;
        }

        public void initializeKeyspace(String keyspace) {
            try (Cluster privilegedCluster = ClusterFactory.create(configuration(keyspace))) {
                provisionNonPrivilegedUser(privilegedCluster);
                KeyspaceFactory.createKeyspace(configuration(keyspace), privilegedCluster);
                grantPermissionTestingUser(privilegedCluster, keyspace);
            }
        }

        public void dropKeyspace(String keyspace) {
            try (Cluster cluster = ClusterFactory.create(configuration(keyspace))) {
        ...
        private ClusterConfiguration configuration(String keyspace) {
    ...
    public DockerCassandra.CassandraResourcesInitializer administrator() {
        return new CassandraResourcesInitializer(this);
    }
