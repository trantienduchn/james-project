...
class MailboxListenerRegistry {
    ...
    void addListener(RegistrationKey registrationKey, MailboxListener listener) {
        listeners.put(registrationKey, listener);
    }

    void removeListener(RegistrationKey registrationKey, MailboxListener listener) {
        listeners.remove(registrationKey, listener);
    }
