...
public class MemoryDeletedMessageVaultModule extends AbstractModule {
    private static final Logger LOGGER = LoggerFactory.getLogger(MemoryDeletedMessageVaultModule.class);

    @Override
    protected void configure() {
        bind(MemoryDeletedMessagesVault.class).in(Scopes.SINGLETON);
        bind(DeletedMessageVault.class)
            .to(MemoryDeletedMessagesVault.class);
    }
