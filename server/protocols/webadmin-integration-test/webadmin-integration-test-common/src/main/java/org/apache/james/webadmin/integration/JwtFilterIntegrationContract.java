...
public interface JwtFilterIntegrationContract {
    ...
    String VALID_TOKEN_ADMIN_TRUE = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbkBvcGVuL" +
    ...
    String VALID_TOKEN_ADMIN_FALSE = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbkBvcGVu" +
    ...
    @Test
    default void jwtAuthenticationShouldWork(DataProbe dataProbe) throws Exception {
        given()
    ...
    @Test
    default void jwtShouldRejectNonAdminRequests(DataProbe dataProbe) throws Exception {
        given()
    ...
    @Test
    default void jwtShouldRejectInvalidRequests(DataProbe dataProbe) throws Exception {
        given()
