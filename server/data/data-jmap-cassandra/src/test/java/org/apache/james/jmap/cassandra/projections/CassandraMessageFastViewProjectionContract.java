...
interface CassandraMessageFastViewProjectionContract extends MessageFastViewProjectionContract {

    @Test
    default void storeShouldThrowWhenMessageIdIsNotCassandraType() {
    ...
    @Test
    default void retrieveShouldThrowWhenMessageIdIsNotCassandraType() {
    ...
    @Test
    default void deleteShouldThrowWhenMessageIdIsNotCassandraType() {
        assertThatThrownBy(() -> testee().retrieve(TestMessageId.of(1)))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessage("MessageId type is required to be CassandraMessageId");
    }
